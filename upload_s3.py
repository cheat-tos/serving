...
train_data = pd.read_csv(args.data_dir+'train_data.csv')
additional_data = pd.read_csv(args.data_dir+'additional_data.csv')
...
added_train_df.to_csv(args.data_dir+'added_train_data.csv', index=False)

file_name = args.data_dir+'added_train_data.csv'
